...
int main() {
	...
	printf("Compressed File Size: %lld\n", (predfilesize+7)/8);//divide by 8 to convert bit into byte and add 7 to take ceil val
	ll finalsize=(predfilesize+7)/8;
	double per=((double)finalsize/filesize)*100;
	cout<<"Percentage Of Compression "<<per<<endl;
